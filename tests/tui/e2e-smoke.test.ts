...
describe('TUI E2E smoke tests', () => {
  ...
  describe('built bundle (node dist/shizuha.js)', () => {
    // The full gate builds dist/shizuha.js once before Vitest starts. Rebuilding
    // it inside a parallel test worker races every other built-bundle E2E: a
    // process can observe esbuild's partially-written outfile and exit 1.
