...
export function resolveWhatsAppVerifyToken(
  ...
  return optionToken || environmentToken;
}

export function whatsappWebhookReadyMessage(webhookPort: number): string {
  return `WhatsApp webhook configured on port ${webhookPort}`;
}
