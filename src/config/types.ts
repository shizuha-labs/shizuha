...
export interface ShizuhaConfig {
  agent: AgentSection;
  loopDetector: LoopDetectorSection;
...
/** SCLI-20(c): tunable loop-detector thresholds (mirrors LoopDetectorConfig). */
export interface LoopDetectorSection {
...
export interface ProvidersSection {
  ...
  cortex?: { baseUrl?: string; apiKey?: string };
}
