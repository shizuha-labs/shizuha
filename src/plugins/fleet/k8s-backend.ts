/**
 * Default-off fleet plugin stub. Public / --no-fleet-plugin builds use this
 * instead of the real Hive/k3s actuator. Local dashboard + TUI still work.
 */
import type { AgentInfo } from '../../daemon/types.js';
import type { DesiredRuntimeRelease } from '../../daemon/runtime-release.js';
