...
export interface BackgroundTask {
  ...
  notified: boolean;
  /** How aggressively to notify the model/TUI about this task */
...
export interface BackgroundTaskWatch {
  id: string;
  /** Task id or description substring supplied by the user */
  target: string;
  policy: TaskNotifyPolicy;
  createdAt: number;
}
