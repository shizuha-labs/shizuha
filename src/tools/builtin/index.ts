...
import { listAgentsTool } from './inter-agent.js';
import { messageUserTool } from './message-user.js';
...
import { remoteExecTool } from './remote-exec.js';
...
export function registerBuiltinTools(registry: ToolRegistry): void {
  ...
  if (process.env['AGENT_USERNAME'] && readAgentCredential('AGENT_PASSWORD')) {
