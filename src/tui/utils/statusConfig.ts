...
const ALL_ITEMS: StatusItem[] = ['model', 'mode', 'activity', 'verbosity', 'context', 'cost', 'tokens', 'turns', 'time', 'lines', 'session', 'branch', 'perf'];

// Keep default statusline compact/human-friendly.
let _items: StatusItem[] = ['model', 'mode', 'activity', 'perf', 'context', 'lines', 'branch'];
