...
# ── Known hosts ──
# Format: HOST:LAYOUT
#   dev       = ~/work/shizuha-stack/cli/dist (development, source checkout)
...
deploy_dev() {
  ...
  rsync -az --delete dist/ "$HOST:work/shizuha-stack/cli/dist/"

  echo "==> Restarting daemon on $HOST..."
  ssh "$HOST" 'cd "$HOME/work/shizuha-stack/cli"
